<?php
    ...
    class CompraDAO {   
        ...
        public static function Insert($elemento){
            ...
            $query = "INSERT INTO `compra`(`articulo`, `precio`, usuario_id) VALUES (:articulo, :precio, :usuario_id)";

            try{
                $db = AccesoDatos::DameUnObjetoAcceso();                 
                $sentencia = $db->RetornarConsulta($query);
                $sentencia->bindValue(':articulo',  $elemento->articulo, PDO::PARAM_STR);                 
                $sentencia->bindValue(':precio',  $elemento->precio, PDO::PARAM_STR);                 
                $sentencia->bindValue(':usuario_id',  $elemento->usuarioId, PDO::PARAM_STR); 
