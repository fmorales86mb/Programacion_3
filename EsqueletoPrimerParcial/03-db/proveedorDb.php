<?php
    ...
    class ProveedorDb{        
        ...
        // True si ya existe el id, false en caso contrario.
        public static function EvalIdProveedor($id){
        ...
        // Retorna el mayor id + 1.
        public static function AsignarIdProveedor(){
            $list = ProveedorDb::GetProveedores();
            $id = -1;
